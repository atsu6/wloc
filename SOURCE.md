...
このリポジトリのShadowrocket用設定は、ユーザーがSourceForgeから取得した **Apple WLOC v1.1.0 source code.zip** を基準に確認しています。
...
※最後の値は可読性のため途中に空白が入っています。正規値は `06acd0530cef9bf0e5bd460ac3f7b95179e09edb29406d43cf2f66ccaebc4071` です。
